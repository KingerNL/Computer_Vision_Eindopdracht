...
ROOT_DIR = os.path.join("../Computer_Vision_Eindopdracht") # Go one folder up
...
if __name__ == '__main__':
    ...
    trainer.resume_or_load(resume=False) #resume staat nu op true --> opnieuw trainen moet je hem op False zetten
    trainer.train()
